...
export default function Pricing() {
  useEffect(() => {
    setPageMeta({
      title:
        "ACH Payment Pricing - BizPay Solutions | Simple, Transparent Rates",
      description:
        "Transparent ACH pricing plans starting at $0.25 per transaction. Essential, Professional, and Enterprise tiers. Free migration offer. No hidden fees.",
      canonicalUrl: "https://www.bizpaysol.com/pricing/",
      keywords:
        "ACH payment pricing, payment processor costs, ACH transaction fees, pricing calculator",
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white py-16">
        <div className="container">
          {(() => {
            ...
            const variant =
              saved ?? (Math.random() < 0.5 ? "free-month" : "migration-help");
            ...
            return (
              <div className="mb-4 rounded-md border bg-slate-50 p-3 text-sm">
                {variant === "free-month" ? (
                  <span>
                    <strong>Promo:</strong> Get your first month free on annual
                    plans.
                  </span>
                ) : (
                  <span>
                    <strong>Promo:</strong> Free white-glove migration from
                    Gusto/Stripe this month.
                  </span>
                )}
              </div>
            );
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            ACH-first plans for builders. Estimate savings and migrate in
            minutes.
          </p>
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Button asChild size="lg">
              <a href="/support#contact">Request Enterprise Demo</a>
            </Button>
          ...
          <section className="mt-10 grid gap-6 md:grid-cols-3">
            <div className="rounded-xl border p-6">
              ...
              <div className="mt-4">
                <Button asChild className="w-full">
                  <a href="/pricing#start">Get Started</a>
                </Button>
              </div>
            </div>
            ...
            <div className="rounded-xl border p-6">
              ...
              <div className="mt-4">
                <Button asChild className="w-full">
                  <a href="/support#contact">Request a Demo</a>
                </Button>
              </div>
            </div>
          </section>
          ...
          <div className="mt-4 text-xs text-muted-foreground">
            Interchange‑free ACH. Additional fees may apply for Same Day ACH,
            returns (R01–R10), and bank verification provider costs.
          </div>
