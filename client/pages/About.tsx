...
export default function About() {
  useEffect(() => {
    setPageMeta({
      ...
      description:
        "Learn about BizPaySol's mission to simplify ACH payments. Trusted by 2000+ businesses, processing 50k+ ACH transfers with 99.95% uptime.",
      canonicalUrl: "https://www.bizpaysol.com/about/",
      keywords:
        "BizPaySol, ACH platform, fintech company, payment processor, about us",
      ogTitle: "About BizPaySol - Our Mission",
      ogDescription:
        "ACH payments should be simple, safe, and in full compliance. Meet the team behind BizPaySol.",
    });
    ...
    setStructuredData({
      ...
      description:
        "Enterprise ACH payment platform for fintech and B2B companies",
      address: {
        "@type": "PostalAddress",
      ...
      <section className="bg-white py-16">
        <div className="container max-w-4xl">
          ...
          <p className="mt-4 text-muted-foreground">
            At Enterprise ACH, we believe transactions shouldn’t be complex or
            risky. We provide fintechs and enterprises with the tools to manage
            ACH transactions safely, efficiently, and in full compliance.
          </p>
            ...
            <div>
              ...
              <div className="mt-3 text-sm text-muted-foreground">
                <p>
                  Email:{" "}
                  <a
                    href="mailto:info@bizpaysol.com"
                ...
                <p>
                  Sales:{" "}
                  <a
                    href="mailto:sales@bizpaysol.com"
                    className="underline decoration-dotted"
                  >
                    sales@bizpaysol.com
                  </a>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Build the simplest, most reliable ACH platform for SMBs and
                developers. Human support, developer‑first APIs, and compliance
                without the bloat.
              </p>
            ...
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                "We built BizPaySol to cut through complexity. Modern ACH should
                be fast, clear, and secure—period."
              </p>
              <p className="mt-4 text-xs text-muted-foreground">
                Want to add a 1‑minute vision video? Share a public video URL
                and we\'ll embed it here.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl mt-12">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Educate CFOs, developers, and compliance leaders on ACH, risk, and
            industry use cases.
          </p>
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              ...
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground">
                <li>
                  ACH 101 for CFOs: Costs, timing, returns, and risk vs
                  cards/wires
                </li>
                <li>NACHA Return Codes Explained (R01–R10, R29)</li>
                <li>Same Day ACH: When it makes sense and how to price it</li>
                <li>
                  Bank Verification: Instant vs micro‑deposits—fraud, UX, ops
                  trade‑offs
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              ...
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground">
                <li>
                  Property Management: Rent collections and reconciliation
                </li>
                <li>Healthcare: Co‑pays, refunds, and PHI considerations</li>
                <li>Logistics: High‑ticket invoicing and DSO reduction</li>
                <li>
                  B2B SaaS: Subscription ACH and involuntary churn prevention
                </li>
              </ul>
            </div>
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              ...
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground">
                <li>
                  Pillar pages, tactical playbooks, and a glossary (NACHA, SEC,
                  ODFI/RDFI)
                </li>
