...
export default function Security() {
  useEffect(() => {
    setPageMeta({
      ...
      description:
        "BizPaySol is SOC 2 Type II certified, NACHA compliant, and ISO 27001 aligned. Enterprise-grade security with TLS 1.2+, AES-256 encryption, and signed webhooks.",
      canonicalUrl: "https://www.bizpaysol.com/security/",
      keywords:
        "SOC 2, NACHA compliance, ISO 27001, payment security, data encryption",
