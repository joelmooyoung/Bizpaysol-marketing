    ...
    <Layout>
      <section className="bg-white py-16">
        <div className="container max-w-5xl">
          <h1 className="text-4xl font-extrabold tracking-tight">BizPay Solutions vs. GoCardless</h1>
          <p className="mt-3 text-muted-foreground">ACH for US B2B vs bank debit in other regions—fit, costs, and integration paths.</p>

          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              <h2 className="text-lg font-semibold">BizPay Solutions for US B2B</h2>
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground">
                <li>US‑focused ACH recurring billing and payouts</li>
                <li>Returns automation and reconciliation for high‑ticket invoices</li>
            ...
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              ...
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground">
                ...
                <li>Useful where multi‑region mandate management is required</li>
              </ul>
            </div>
          </div>
