...
export default function CaseStudies() {
  useEffect(() => {
    setPageMeta({
      ...
      description:
        "See how companies reduced ACH costs by 30-65%, improved reconciliation, and launched faster with BizPaySol. Real case studies and ROI metrics.",
      canonicalUrl: "https://www.bizpaysol.com/case-studies/",
      keywords:
        "ACH case studies, payment processor success stories, fintech ROI, cost savings",
      ogTitle: "BizPaySol Case Studies",
      ogDescription:
        "How teams use BizPaySol to reduce cost and time-to-launch on ACH.",
    });
    ...
    setStructuredData({
      ...
      description:
        "Real-world examples of how businesses benefit from BizPaySol ACH platform",
    });
  }, []);
  return (
    <Layout>
      <section className="bg-gradient-to-b from-blue-50 to-white py-16">
        <div className="container max-w-5xl">
          ...
          <p className="mt-3 text-lg text-slate-600">
            How companies transformed their payment operations and cut costs
            with BizPaySol.
          </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <article className="rounded-lg border p-6 hover:shadow-md transition">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                "Reduced DSO from 45 to 18 days. ACH recovery alone saves us
                $156k/year. Integration took 3 days."
              </p>
            ...
            <article className="rounded-lg border p-6 hover:shadow-md transition">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                "Our developer loved the API. Reduced payment reconciliation
                workload by 65%. Went live in 7 days."
              </p>
              <div className="mt-4 pt-4 border-t space-y-2 text-xs">
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Monthly volume:</span>
                  <span className="font-semibold">$8.1M</span>
                </div>
              </div>
            </article>
            <article className="rounded-lg border p-6 hover:shadow-md transition">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    B2B Marketplace, $8M ARR
                  </p>
                </div>
              </div>
              <p className="mt-3 text-sm text-muted-foreground">
                "Eliminated manual reconciliation. Webhooks auto-update our
                accounting system. 2,400+ vendors paid daily."
              </p>
              <div className="mt-4 pt-4 border-t space-y-2 text-xs">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">30 hrs/mo</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Monthly volume:</span>
          ...
          <div className="mt-12 space-y-4">
            ...
            <p className="text-muted-foreground">
              Detailed breakdowns showing how companies transformed their
              payment operations.
            </p>
            <div className="bg-slate-50 rounded-lg p-8 border">
              <h3 className="text-lg font-semibold mb-4">
                FleetSync Pro - Logistics Tech
              </h3>
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <p className="text-sm mb-4">
                    FleetSync was processing $15M/month in driver payouts and
                    fuel reimbursements. With legacy wire transfers, they faced:
                  </p>
                ...
                <div>
                  ...
                  <p className="text-sm mb-4">
                    Migrated to BizPaySol's intelligent ACH with:
                  </p>
                  <ul className="text-sm space-y-1 text-muted-foreground list-disc pl-5">
